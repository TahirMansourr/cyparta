...
import { PiScrollLight, PiWallet } from "react-icons/pi";
        ...
        <section className='flex h-screen py-[20px] pl-[28px]'>
            <div className='flex flex-col h-full w-[300px] mx-3 border shadow-md rounded-3xl items-center'>
                ...
                <div className='flex flex-col w-full gap-3'>
                    <div 
                        className={`sideBarItem-before ${firstNavigator === 'Employees' ? 'border-l-4 border-l-red-600 bg-[#F9EAEB] text-[#EE232F] py-2 rounded-r-xl' : ''} ${lexend.className}`} 
                        onClick={() => {
                    ...
                    <div 
                        className={`flex items-center justify-between transition-all duration-200 ease-in-out hover:cursor-pointer ${firstNavigator === 'Payroll' ? 'border-l-4 border-l-red-600 bg-[#F9EAEB] text-[#EE232F] py-2 rounded-r-xl' : ''}`} 
                        onClick={() => {
                            setFirstNavigator('Payroll');
                            setSecondNavigator(null);
                        }}
                    >
                        <div className={`flex items-center gap-3 px-3 pl-10 ${lexend.className}`}>
                            <CiDollar size={30} />
                            <p>Payroll</p>
                        </div>
                        <div className='pr-5'>
                    ...
                    <div 
                        className={`flex items-center justify-between transition-all duration-200 ease-in-out hover:cursor-pointer ${firstNavigator === 'Holidays' ? 'border-l-4 border-l-red-600 bg-[#F9EAEB] text-[#EE232F] py-2 rounded-r-xl' : ''} ${lexend.className}`} 
                        onClick={() => {
                    ...
                    <div 
                        className={`flex items-center justify-between transition-all duration-200 ease-in-out hover:cursor-pointer ${firstNavigator === 'Advanced Payments' ? 'border-l-4 border-l-red-600 bg-[#F9EAEB] text-[#EE232F] py-2 rounded-r-xl' : ''} ${lexend.className}`} 
                        onClick={() => {
